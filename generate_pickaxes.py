...
def recolor_pickaxe_preserve_variation(input_path, output_path, bright_rgb, medium_rgb, dark_rgb):
    """
    Recolor pickaxe while preserving color variation like vanilla Minecraft.
    ...
    for r in range(pixels.shape[0]):
        for c in range(pixels.shape[1]):
            ...
            if pixel[3] > 0:  # Not transparent
                # Check if this is a cyan/aqua pixel (pickaxe head)
...
input_file = "templates/pickaxes/diamond_pickaxe.png"
output_dir = "assets/minecraft/textures/item/pickaxes"

# Ensure output directory exists
os.makedirs(output_dir, exist_ok=True)

# Define all pickaxes with their base colors
pickaxes = [
    ("loam_soil_pickaxe.png", (58, 43, 36)),
    ("peat_pickaxe.png", (96, 60, 32)),
    ("dirt_pickaxe.png", (134, 96, 67)),
    ("ryegrass_pickaxe.png", (76, 83, 42)),
    ("lemon_grass_pickaxe.png", (166, 182, 85)),
    ("oak_leaves_pickaxe.png", (74, 110, 41)),
    ("silvergrass_pickaxe.png", (110, 135, 65))
]

print("Generating pickaxe textures with color variation...")
print("=" * 60)

# Set random seed for reproducibility
np.random.seed(42)

for filename, base_color in pickaxes:
    output_path = os.path.join(output_dir, filename)
    bright, medium, dark = create_shades(base_color)
    recolor_pickaxe_preserve_variation(input_file, output_path, bright, medium, dark)

print("=" * 60)
print(f"All {len(pickaxes)} pickaxe textures regenerated!")
